...
import { 
  StyleSheet, View, Text, TouchableOpacity, StatusBar, KeyboardAvoidingView, Platform, ScrollView, Modal 
} from 'react-native'; // REMOVIDO SafeAreaView daqui
...
export default function App() {
  ...
  return (
    // --- SAFE AREA PROVIDER (Envolve tudo) ---
    <SafeAreaProvider>
      {/* SAFE AREA VIEW (Substitui o container principal) */}
